...
export default function AdminHome({ userData }) {
  ...
  const getAllUser = () => {
    fetch("https://kitchenrecipemanagement.onrender.com/getAllUser", {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
...
//logout
  ...
  const handleSubmit=(e) => {
    ...
    fetch("https://kitchenrecipemanagement.onrender.com/addRecipe", {
        method: "POST",
        crossDomain: true,
        headers: {
  ...
  const deleteUser = (id, name) => {
    if (window.confirm(`Are you sure you want to delete ${name}`)) {
      fetch("https://kitchenrecipemanagement.onrender.com/deleteUser", {
        method: "POST",
        crossDomain: true,
        headers: {
          "Content-Type": "application/json",
  ...
  function getPaginatedUsers(){
    fetch(`https://kitchenrecipemanagement.onrender.com/paginatedUsers?page=${currentPage.current}&limit=${limit}`, {
      method: "GET",
    })
      .then((res) => res.json())
      .then((data) => {
...
function uploadImage() {
  fetch("https://kitchenrecipemanagement.onrender.com/upload-image", {
      method: "POST",
      crossDomain: true,
      headers: {
          "Content-Type": "application/json",
